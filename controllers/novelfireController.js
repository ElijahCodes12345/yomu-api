...
class NovelFireController {
  constructor() {
    this.model = novelfireModel;
  }

  searchNovels = async (req, res) => {
    try {
      const query = req.query.q || req.query.keyword || req.query.text;
      ...
      console.error('NovelFire Search Error:', error);
  ...
  getNovelInfo = async (req, res) => {
    try {
      ...
      console.error('NovelFire Novel Info Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
  ...
  getNovelChapters = async (req, res) => {
    try {
      ...
      console.error('NovelFire Novel Chapters Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
  ...
  getChapterContent = async (req, res) => {
    try {
      ...
      console.error('NovelFire Chapter Content Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
  ...
  getLatest = async (req, res) => {
    try {
      ...
      console.error('NovelFire Latest Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
  ...
  getRanking = async (req, res) => {
    try {
      ...
      console.error('NovelFire Ranking Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
  ...
  getGenres = async (req, res) => {
    try {
      ...
      console.error('NovelFire Genres Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
  ...
  getNovelsByGenre = async (req, res) => {
    try {
      ...
      console.error('NovelFire Novels by Genre Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
  ...
  getHomePage = async (req, res) => {
    try {
      ...
      console.error('NovelFire Home Page Error:', error);
      res.status(500).json({ status: 500, error: error.message || 'Internal Server Error' });
    }
  }
}

module.exports = new NovelFireController();
